...
class Collection:
    ...
    def __init__(
        self, connection: DBusConnection, collection_path: str = DEFAULT_COLLECTION, session: Session | None = None
    ) -> None:
...
def create_collection(
    connection: DBusConnection, label: str, alias: str = "", session: Session | None = None
) -> Collection:
...
def get_default_collection(connection: DBusConnection, session: Session | None = None) -> Collection:
