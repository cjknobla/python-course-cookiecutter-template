...
class PackageFile:
    ...
    def from_filename(cls, filename: str, comment: Optional[str]) -> "PackageFile":
        ...
        try:
            ...
            raise exceptions.InvalidDistribution(
                "Invalid distribution metadata: {}".format("; ".join(sorted(str(e) for e in group.exceptions)))
            )
        ...
        for attestation in attestations:
            with open(attestation, "rb") as att:
                try:
                    ...
                    raise exceptions.InvalidDistribution(f"invalid JSON in attestation: {attestation}")
