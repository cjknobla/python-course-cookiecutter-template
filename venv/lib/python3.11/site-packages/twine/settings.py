...
class Settings:
    ...
    def verify_feature_capability(self) -> None:
        ...
        if self.skip_existing and not repository_url.startswith((repository.WAREHOUSE, repository.TEST_WAREHOUSE)):
            raise exceptions.UnsupportedConfiguration.Builder().with_feature("--skip-existing").with_repository_url(
                repository_url
            ).finalize()
