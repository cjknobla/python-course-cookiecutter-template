...
class TestNonarrayArgs:
    ...
    def test_reshape_shape_arg(self):
        ...
        with pytest.raises(
            TypeError, match="You cannot specify 'newshape' and 'shape' " "arguments at the same time."
        ):
...
class TestClip:
    ...
    @given(
        data=st.data(),
        arr=hynp.arrays(dtype=hynp.integer_dtypes() | hynp.floating_dtypes(), shape=hynp.array_shapes()),
    )
