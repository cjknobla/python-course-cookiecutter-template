...
@pytest.mark.skipif(
    (platform.system() != "Linux") or (sys.version_info <= (3, 12)), reason="Compiler and 3.12 required"
)
...
@pytest.mark.skipif(
    (platform.system() != "Linux") or sys.version_info <= (3, 12), reason="Compiler and Python 3.12 or newer required"
)
