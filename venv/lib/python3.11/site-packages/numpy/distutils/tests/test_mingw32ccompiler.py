...
@pytest.mark.skipif(not os.path.exists(os.path.join(sys.prefix, "libs")), reason="test requires mingw library layout")
@pytest.mark.skipif(
    sysconfig.get_platform() == "win-arm64", reason="mingw GNU objdump does not understand arm64 binary format yet"
)
