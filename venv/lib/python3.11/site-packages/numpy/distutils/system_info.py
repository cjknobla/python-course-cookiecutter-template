...
class x11_info(system_info):
    ...
    def __init__(self):
        system_info.__init__(
            self, default_lib_dirs=default_x11_lib_dirs, default_include_dirs=default_x11_include_dirs
        )
...
class amd_info(system_info):
    ...
    def calc_info(self):
        ...
        if inc_dir is not None:
            dict_append(
                info, include_dirs=[inc_dir], define_macros=[("SCIPY_AMD_H", None)], swig_opts=["-I" + inc_dir]
            )
