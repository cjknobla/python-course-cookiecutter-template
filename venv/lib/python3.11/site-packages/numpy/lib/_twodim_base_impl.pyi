...
) -> tuple[NDArray[float64], NDArray[_ComplexFloatingT], NDArray[_ComplexFloatingT],]: ...
@overload
def histogram2d(
...
def histogram2d(
    ...
    density: bool | None = ...,
    weights: _ArrayLike1DFloat_co | None = ...,
) -> tuple[NDArray[float64], NDArray[complex128 | float64], NDArray[complex128 | float64],]: ...
@overload
def histogram2d(
...
def histogram2d(
    ...
    density: bool | None = ...,
    weights: _ArrayLike1DFloat_co | None = ...,
) -> tuple[NDArray[float64], NDArray[_NumberCoT | _InexactT], NDArray[_NumberCoT | _InexactT],]: ...
@overload
def histogram2d(
    x: _ArrayLike1DInt_co | Sequence[float],
    y: _ArrayLike1DInt_co | Sequence[float],
    ...
    density: bool | None = ...,
    weights: _ArrayLike1DFloat_co | None = ...,
) -> tuple[NDArray[float64], NDArray[_NumberCoT | float64], NDArray[_NumberCoT | float64],]: ...
@overload
def histogram2d(
    x: Sequence[complex],
    y: Sequence[complex],
...
def histogram2d(
    ...
    density: bool | None = ...,
    weights: _ArrayLike1DFloat_co | None = ...,
) -> tuple[NDArray[float64], NDArray[np.int_ | np.bool], NDArray[np.int_ | np.bool],]: ...
@overload
def histogram2d(
    x: _ArrayLike1DNumber_co,
    y: _ArrayLike1DNumber_co,
    ...
    density: bool | None = ...,
    weights: _ArrayLike1DFloat_co | None = ...,
) -> tuple[NDArray[float64], NDArray[np.float64 | np.int_ | np.bool], NDArray[np.float64 | np.int_ | np.bool],]: ...
@overload
def histogram2d(
    x: _ArrayLike1DNumber_co,
    y: _ArrayLike1DNumber_co,
