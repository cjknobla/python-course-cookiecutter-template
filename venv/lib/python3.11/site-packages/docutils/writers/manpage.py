...
def insert_URI_breakpoints(s):
    ...
    return NONBREAKING_INSERT_RE2.sub(
        r"\1" + NONPRINTING_BREAKPOINT, NONBREAKING_INSERT_RE.sub(r"\1" + NONPRINTING_BREAKPOINT, s)
    )
    ...
    settings_spec = (
        ...
        (
            ...
            (
                ...
                ["--macro-references"],
                {"dest": "text_references", "action": "store_false", "validator": frontend.validate_boolean},
            ),
        ),
    )
...
class Translator(nodes.NodeVisitor):
    ...
    def depart_document(self, node) -> None:
        ...
        skip = ("author", "copyright", "date", "manual_group", "manual_section", "subtitle", "title", "version")
    ...
    def visit_image(self, node):
        ...
        if "alt" in node.attributes:
            ...
            self.document.reporter.warning(
                f'{msg}\nPlease provide an "alt" attribute with textual' " replacement.", base_node=node
            )
