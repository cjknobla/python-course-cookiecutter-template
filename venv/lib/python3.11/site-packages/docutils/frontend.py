...
class Values(optparse.Values):
    ...
    def __init__(self, defaults: dict[str, Any] | None = None) -> None:
        warnings.warn(
            "frontend.Values class will be removed " "in Docutils 2.0 or later.", DeprecationWarning, stacklevel=2
        )
...
class Option(optparse.Option):
    ...
    def __init__(self, *args: str | None, **kwargs: Any) -> None:
        warnings.warn(
            "The frontend.Option class will be removed " "in Docutils 2.0 or later.", DeprecationWarning, stacklevel=2
        )
...
class OptionParser(optparse.OptionParser, docutils.SettingsSpec):
    ...
    threshold_choices: ClassVar[tuple[str]] = ("info", "1", "warning", "2", "error", "3", "severe", "4", "none", "5")
    """Possible inputs for for --report and --halt threshold values."""

    thresholds: ClassVar[dict[str, int]] = {"info": 1, "warning": 2, "error": 3, "severe": 4, "none": 5}
    ...
    default_error_encoding: ClassVar[str] = getattr(sys.stderr, "encoding", None) or io._locale_encoding or "ascii"
    ...
    settings_spec = (
        ...
        (
            ...
            (
                "Specify the encoding and optionally the " "error handler of input text.  Default: utf-8.",
                ["--input-encoding"],
            ...
            (
                "Specify the text encoding and optionally the error handler for " "output.  Default: utf-8.",
                ["--output-encoding"],
                {"metavar": "<name[:handler]>", "default": "utf-8", "validator": validate_encoding_and_error_handler},
            ),
            (
