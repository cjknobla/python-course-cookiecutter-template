...
class Transitions(Transform):
    ...
    def visit_transition(self, node) -> None:
        ...
        elif index == 0 or isinstance(previous_sibling, (nodes.title, nodes.subtitle, nodes.meta, nodes.decoration)):
        ...
        while index == len(sibling.parent) - 1:
            ...
            if sibling.parent is None:  # sibling is the top node (document)
                ...
                warning = self.document.reporter.warning("Document may not end with a transition.", base_node=node)
