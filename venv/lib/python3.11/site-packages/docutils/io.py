...
try:
    ...
    with warnings.catch_warnings():
        ...
        _locale_encoding: str | None = (locale.getlocale()[1] or locale.getdefaultlocale()[1]).lower()
...
class ErrorOutput:
    ...
    def __init__(
        ...
        self.encoding: str = encoding or getattr(destination, "encoding", None) or _locale_encoding or "ascii"
...
class BinaryFileOutput(FileOutput):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        warnings.warn(
            '"BinaryFileOutput" is obsoleted by "FileOutput"' " and will be removed in Docutils 0.24.",
            DeprecationWarning,
            stacklevel=2,
        )
