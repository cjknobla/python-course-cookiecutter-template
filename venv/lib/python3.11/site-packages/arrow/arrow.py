...
class Arrow:
    ...
    def span(
        ...
        ceil = floor.shift(check_imaginary=True, **{frame_relative: count * relative_steps})
    ...
    def humanize(
        ...
        try:
            if granularity == "auto":
                ...
                calendar_diff = (
                    relativedelta(dt, self._datetime) if self._datetime < dt else relativedelta(self._datetime, dt)
                )
                calendar_months = calendar_diff.years * self._MONTHS_PER_YEAR + calendar_diff.months
